...
server.tool(
  "query",
  "Ask a question to the FCM RAG knowledge base. Use this tool to search for information about FCM processes, policies, onboarding, and any other company knowledge.",
  {
